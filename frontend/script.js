document.addEventListener('DOMContentLoaded', () => {
    ...
    // Automatically use localhost for development, or the current origin when deployed
    const isLocalhost = window.location.hostname === 'localhost' || window.location.hostname === '127.0.0.1';
    const BACKEND_URL = isLocalhost ? 'http://localhost:8000' : window.location.origin;
